<x-layouts::app :title="__('Edit Send')">
    <div class="mx-auto w-full max-w-2xl">
        <h1 class="mb-6 text-2xl font-semibold text-zinc-900 dark:text-white">{{ __('Edit Send') }}</h1>
            ...
            >
                ...
                <div class="mb-5">
                    ...
                    <textarea
                        ...
                        required
                    >{{ old('message', $send->message) }}</textarea>
                    @error('message')
                        <span class="mt-1 block text-sm text-red-600">{{ $message }}</span>
                    @enderror
                </div>
